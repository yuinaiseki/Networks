...
public class SingleRunDriver {
    ...
    public SingleRunDriver() {
        LATICE_DIMENTIONS[0] = 12;
        LATICE_DIMENTIONS[1] = 12;
        NUM_AGENTS = 144;
    }

    public SingleRunDriver(int latdim) {
 ...
 /*
    ...
    */
    public int[][] getEnv() {
        ...
        for (int i = 0; i < NUM_AGENTS; i++) {
            agentloc[0] = i / LATICE_DIMENTIONS[0];
            agentloc[1] = i % LATICE_DIMENTIONS[0];
            if (Agents[i].isAlive()) {
                if (Agents[i].isCooperator()) {
                    rtn[agentloc[0]][agentloc[1]] = 1;
                } else {
                    rtn[agentloc[0]][agentloc[1]] = 2;
                }
            } else {
                rtn[agentloc[0]][agentloc[1]] = 0;
            }
        }
        return rtn;
    }
    ...
    */
    public void setupAgents() {
        ...
        int startingDefector;
        if(LATICE_DIMENTIONS[1] % 2 == 1){
            startingDefector = (int) NUM_AGENTS / 2;
        }else{
            startingDefector = (int)( NUM_AGENTS / 2) + (LATICE_DIMENTIONS[1] / 2);
        }
